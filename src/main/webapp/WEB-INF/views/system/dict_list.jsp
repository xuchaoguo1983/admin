...
<body>
						...
						<div class="table-actions-wrapper">
							<form class="form-inline">
								<div class="form-group">
									<label for="code">字典代码</label> <input type="text"
										class="form-control form-filter" name="code"
										placeholder="字典代码">
								</div>
						...
						<table class="table table-striped table-bordered table-hover"
							...
							<thead>
								<tr role="row" class="heading">
									<th data-name="code" data-order="asc" class="sortable">字典代码</th>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="btn-group">
								<button data-toggle="modal" href="#dictCodeModel" class="btn green">
	...
	<!-- 字典项信息 -->
	<div class="modal fade" id="dictCodeModel" tabindex="-1" data-focus-on="input:first"
		aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
	...
	<content tag="footer"> <script
		src="static/pages/scripts/system/dict.js" type="text/javascript"></script>
	<script>
