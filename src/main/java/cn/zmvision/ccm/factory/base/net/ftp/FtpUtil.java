package cn.zmvision.ccm.factory.base.net.ftp;
...
public class FtpUtil {
	...
	public void connectServer() throws SocketException, IOException {
		connectServer(this.ftpHost, this.ftpPort, this.ftpUserName,
				this.ftpPassword, this.ftpRoot);
	}
	...
	public void connectServer(String server, int port, String user,
		...
		// 连接成功后的回应码
		logger.info("reply code: {}", ftpClient.getReplyCode());
	...
	public boolean changeDirectory(String path) throws IOException {
		logger.debug("change to directory: {}", path);
	...
	public boolean createDirectory(String pathName) throws IOException {
		logger.debug("create directory: {}", pathName);
	...
	public boolean deleteFile(String pathName) throws IOException {
		logger.debug("delete file:{}", pathName);
